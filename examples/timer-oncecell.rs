...
//! variable.
//!
//! The [Periperhals](msp430g2231::Peripherals) type, and individual peripherals never need
//! to be modified. Therefore, [Periperhals](msp430g2231::Peripherals) (or a subset of the
...
use msp430_rt::entry;
use msp430g2231::{interrupt, Peripherals};
